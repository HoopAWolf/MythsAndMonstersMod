...
@OnlyIn(Dist.CLIENT)
public class NatureAuraParticle extends SpriteTexturedParticle
{
    private NatureAuraParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
