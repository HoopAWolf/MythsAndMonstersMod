...
public class SpawnOrbitingParticleMessage extends MessageToClient
{
    ...
    public static SpawnOrbitingParticleMessage decode(PacketBuffer buf)
    {
    ...
    {
        return "SpawnOrbitingParticleMessageToClient[targetCoordinates=" + String.valueOf(targetCoordinates) + "]";
    }
}
