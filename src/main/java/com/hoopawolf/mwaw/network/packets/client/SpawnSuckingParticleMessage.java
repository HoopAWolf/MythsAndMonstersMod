...
public class SpawnSuckingParticleMessage extends MessageToClient
{
    ...
    public SpawnSuckingParticleMessage(Vector3d i_targetCoordinates, Vector3d i_targetSpeed, int _iteration, int _particle_type, double _spread)
    {
        messageIsValid = true;
        messageType = 3;
    ...
    public static SpawnSuckingParticleMessage decode(PacketBuffer buf)
    {
        ...
        return new SpawnSuckingParticleMessage(new Vector3d(x, y, z), new Vector3d(speedx, speedy, speedz), iterationAmount, particletype, spreadDist);
    }
